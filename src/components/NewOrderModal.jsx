...
import { X, Plus, AlertCircle, Check, Key, RefreshCw } from 'lucide-react';
...
export default function NewOrderModal({ isOpen, onClose, onOrderCreated }) {
  ...
  const handlePreset = (preset) => {
    setFormData((prev) => ({ ...prev, product: preset.name, category: preset.cat, dimensions: preset.defaultDim }));
  };

  const handleRegeneratePassword = () => {
    setFormData((prev) => ({ ...prev, client_password: generateCleanPassword() }));
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-[#11141c] border border-[#1f2533] rounded-lg shadow-2xl overflow-hidden my-8">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 max-h-[80vh] overflow-y-auto text-xs">
          ...
          {/* Presets */}
          <div>
            <label className="block text-[11px] font-semibold text-slate-400 mb-1">Standard Fabrication Templates</label>
          ...
          <div className="pt-2 border-t border-[#1f2533] space-y-3">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-slate-500 block">1. Client &amp; Billing Contact</span>
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-300 mb-1">Contact Email (Optional)</label>
              <input
                type="email"
          ...
          <div className="pt-2 border-t border-[#1f2533] space-y-2.5 bg-[#161a24]/50 p-3 rounded border border-[#1f2533]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-[11px] font-medium text-slate-300 mb-1">Client Portal ID (Username)</label>
                <input
                  type="text"
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-[11px] font-medium text-slate-300">Client Access Password</label>
                  <button
                    type="button"
          ...
          {/* Section 3: Specs */}
          <div className="pt-2 border-t border-[#1f2533] space-y-3">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-slate-500 block">3. Fabrication &amp; Material Specs</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-[11px] font-medium text-slate-300 mb-1">Dimensions / Physical Size</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[11px] font-medium text-slate-300 mb-1">Category Classification</label>
                <select
            ...
            <div>
              <label className="block text-[11px] font-medium text-slate-300 mb-1">Engineering Notes / Finish Requirements</label>
              <textarea
                rows="2"
          ...
          {/* Section 4: Delivery */}
          <div className="pt-2 border-t border-[#1f2533] space-y-3">
            <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-slate-500 block">4. Fulfillment &amp; Destination</span>
            <div>
              <label className="block text-[11px] font-medium text-slate-300 mb-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="block text-[11px] font-medium text-slate-300 mb-1">Job Priority</label>
                <select
              ...
              <div>
                <label className="block text-[11px] font-medium text-slate-300 mb-1">Target Completion Date</label>
                <input
                  type="date"
          ...
          <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-[#1f2533]">
            <button type="button" onClick={onClose} className="px-3 py-1.5 rounded text-xs text-slate-400 hover:text-white hover:bg-slate-800 transition-colors">
              Cancel
            </button>
            <button
              type="submit"
